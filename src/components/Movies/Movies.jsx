  ...
  return (
    <div className={`${darkLight ? "background-light" : "background-dark"}`} id="movies" style={{ paddingTop: "50px" }}>
      <div className="container">
        ...
        <MoviesList moviesListType={"like"} movies={likeMovies} setLikeMovies={setLikeMovies} setUnLikeMovies={setUnLikeMovies} setWatchLaterMovies={setWatchLaterMovies} activeCategory={activeCategory} />
        <MoviesList moviesListType={"unLike"} movies={unLikeMovies} setLikeMovies={setLikeMovies} setUnLikeMovies={setUnLikeMovies} setWatchLaterMovies={setWatchLaterMovies} activeCategory={activeCategory} />
        <MoviesList moviesListType={"watchLater"} movies={watchLaterMovies} setLikeMovies={setLikeMovies} setUnLikeMovies={setUnLikeMovies} setWatchLaterMovies={setWatchLaterMovies} activeCategory={activeCategory} />
      </div>
    </div>
  );
}
